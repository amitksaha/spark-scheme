...
#include <stdlib.h>
#include "flstring.h"
#include "../mzs/src/mzscheme/include/scheme.h"
...
// for thread managment from MzScheme
bool Fl::_thread_manager_running = false;

void Fl::thread_manager_running(bool r) {
  _thread_manager_running = r;
}

bool Fl::thread_manager_running() {
  return _thread_manager_running;
}
// :~
